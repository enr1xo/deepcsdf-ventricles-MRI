...
W_PROJ = 0.1   # basalità lungo asse apex-base
W_AREA = 0.4    # la tricuspide è spesso una patch grande
W_GEOM = 0.5     # prior geometrico da regolare
...
# ============================================================
# CHOOSE TRICUSPID PATCH
# ============================================================

tricuspid_patch_info = patch_infos[0]

tricuspid_region = tricuspid_patch_info["rid"]

print(
    f"\nChosen tricuspid region: "
    f"{tricuspid_region}"
)

tricuspid_centroid = tricuspid_patch_info["centroid"]

print("Tricuspid centroid:", tricuspid_centroid)
...
other_patch_mask = (
    (rv.cell_data["isholepatch"] == 1) &
    (rv.cell_data["tricuspid_patch"] == 0)
)
