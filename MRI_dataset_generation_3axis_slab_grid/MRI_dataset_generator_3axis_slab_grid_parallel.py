"""
GENERAZIONE PARALLELA DEL DATASET MRI GRID-BASED
================================================
...
OUTPUT_DIR = Path(
    ...
    "MRI_model/generated_npy_three_axis_grid_planaeLA_075mmLA_075mmSA"
)
...
def generate_parallel_batch():
    ...
    print("\n" + "=" * 72)
    print("PARALLEL GRID-BASED MRI DATASET GENERATION")
    print("=" * 72)
